                    ...
                    <div className="space-y-6">
                        ...
                        <div className="flex items-center justify-between py-3 border-b border-[var(--border)]">
                            <div>
                                ...
                                <p className="text-sm text-[var(--text-muted)]">Automatically start analysis upon upload.</p>
                            </div>
                            <button
                        ...
                        <div className="flex items-center justify-between py-3">
                            <div>
                                ...
                                <p className="text-sm text-[var(--text-muted)]">Receive alerts for completed analyses.</p>
                            </div>
                            <button
